...
boundary p p p 
atom_style atomic
region box block -1 24 -15 30 -20 20
create_box 1 box
mass 1 12.011
...
dump 1 all custom 10000 armchair_nr.dump id type x y z vx vy vz
...
reset_timestep 0
dump myDump all atom 10000 dump_reset_armchair_nr.lammpstrj
